...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        if "download" in steps_to_execute:
            ...
            mlflow.run(
                uri=f"{config['main']['components_repository']}#get_data",  # Git-compatible syntax
                entry_point="main",
                parameters={
        ...
        if "data_split" in steps_to_execute:
            ...
            mlflow.run(
                uri=f"{config['main']['components_repository']}#train_val_test_split",  # Git-compatible syntax
                entry_point="main",
                parameters={
